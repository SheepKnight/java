...
public class SmokeParticleBlock extends Block{
	public SmokeParticleBlock(Material material) {
		super(material);
	...
	public void randomDisplayTick(World world, int x, int y, int z, Random random) {
		...
		world.spawnParticle("smoke", (double)(x1), (double)(y1), (double)(z1), 0D, 0.3F, 0D);
