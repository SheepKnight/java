...
public class RenderTable extends TileEntitySpecialRenderer{
	...
	private static final ResourceLocation texture = new ResourceLocation(creatopiamods.modid +":"+"textures/model/OakTable.png");	
	
	private ModelOakWoodTable model;
	

	public RenderTable() {
		this.model = new ModelOakWoodTable();
	}
