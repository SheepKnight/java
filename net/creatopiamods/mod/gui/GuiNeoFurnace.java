...
public class GuiNeoFurnace extends GuiContainer{
public static final ResourceLocation bground = new ResourceLocation(creatopiamods.modid + ":" + "textures/gui/GuiNeoFurnace.png");
	
public TileEntityNeoFurnace neoFurnace;
	
	public GuiNeoFurnace(InventoryPlayer inventoryPlayer, TileEntityNeoFurnace entity) {
